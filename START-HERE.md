...
If you are at L0 and the user wants more, point them at `install/ATTACH.md`. Do not block on
...
- Deeper integration (one command): `install/ATTACH.md`
- What this is and why it works: `README.md`
- Worked end-to-end examples: `EXAMPLES.md`
- Building the enforced runtime (L1/L2): `build/BUILD-MASTER-PROMPT.md`
